...
//    private var lastEvent : String? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // RA: Removing Location and sensor related code
...
//        mAccel = sensorManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER)
    ...
    // RA: removing OnLocationChanged, onSensorChanged, onAccuracyChanged
...
//    }
    ...
    override fun onResume() {
        super.onResume()
        //RA: Removing sensorManager.registerListener
//        mAccel?.also { accel ->
...
//        }
    ...
    override fun onPause() {
        super.onPause()
        //RA: Removing sensorManager.unregisterListener
